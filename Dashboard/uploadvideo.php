                  ...
                  <div class="row">
                    <div class="col-md-6 container-fluid">
                       <form id="uploadvideo" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                        <input type="text" name="video_url" id="video_url" required class="form-control" placeholder="Enter video link">
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
  ...
  $('#uploadvideo').on('submit', function(e) {
      e.preventDefault();
      var type="uploadvideo";
      var formData = new FormData(document.querySelector("#uploadvideo"));
