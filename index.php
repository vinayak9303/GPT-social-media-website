...
<html lang="en">
    						...
    						<div class="one-half">
    							<div class="featured-blog d-md-flex">
    								...
    								<div class="text order-first">
    									<span class="date">Established in  1985</span>
    									<h3><a href="about.php">Know more about us</a></h3>
											<p>The Institute belongs to Government of Maharashtra & under the governance of the Director of Technical education (M.S.) Mumbai. </p>
    								</div>
    							</div>
    						</div>
    					</div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-3" >
             <div class="ftco-footer-widget mb-4 ml-md-4">
              <h2 class="ftco-heading-2" style="margin-left: 60px">Site Links</h2>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Government Polytechnic College, Thane </a>
